...
psid_quintile %>%
  ...
  labs(title="Top 20% of PSID households earns larger share of income than bottom 80%", subtitle= "Share of total household income by quintile", x = "Income Quintile", y = "Share of Total Income") +
  theme_minimal() +
  theme(legend.position = "bottom",
        title = element_text(face="bold"))
