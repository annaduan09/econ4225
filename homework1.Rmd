...
A variance decomposition shows that most earnings inequality arises from wage dispersion: the variance of log wages (0.87) is much larger than the variance of log weeks worked (0.17). The positive covariance (0.15) indicates that individuals with higher wages also tend to work more weeks, which further amplifies overall earnings inequality. This suggests that differences in wages contribute far more to earnings inequality than differences in weeks worked. The caveat with this approach, however, is that we are excluding household heads who did not work or receive labor earnings. This omission may downplay the impact of weeks worked on labor earning inequality, as those at the bottom of the earnings distribution may be working less due to fewer employment opportunities.
